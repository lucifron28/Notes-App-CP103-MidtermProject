...
public:
    ...
    void setupUi(QDialog *NoteDialog)
    {
        ...
        NoteDialog->resize(362, 394);
        textEdit = new QTextEdit(NoteDialog);
        textEdit->setObjectName("textEdit");
        textEdit->setGeometry(QRect(0, 40, 361, 311));
...
"color: black;"));
        ...
        lineEdit->setGeometry(QRect(0, 0, 361, 41));
...
"color: white;"));
        ...
        saveButton->setGeometry(QRect(60, 360, 83, 29));
...
"border-radius: 5px;"));
        ...
        cancelButton->setGeometry(QRect(220, 360, 83, 29));
